...
target = imread('imgs/p4/highlight_removal/orange.jpg');
target = im2double(target);
mask = imread('imgs/p4/highlight_removal/orange_mask.jpg');
mask = im2double(mask);
...
clc
img = imread('imgs/p4/image_segmentation/puppy.jpg');
img = im2double(img);
