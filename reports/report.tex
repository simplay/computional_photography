...
Before starting this task, helper intermediate result later used for the proof. This is rather advanced stuff, but the final result will help us proving the fact we have to prove. :) \\
...
The final result in equation $\ref{eq:final_helper_thingy}$ will be used in the following proof.
